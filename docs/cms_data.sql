-- Add new columns to pages table for menu ordering, if they don't exist
ALTER TABLE pages ADD COLUMN IF NOT EXISTS show_in_menu BOOLEAN DEFAULT FALSE;
ALTER TABLE pages ADD COLUMN IF NOT EXISTS menu_order INTEGER DEFAULT 0;
